...
init_required_tools() {
  ...
  case "$os" in
    macos)
      parse_package_file "$repo_root/macos/Brewfile" _register_tool_callback
      ;;
    arch)
      parse_package_file "$repo_root/arch/Pacmanfile" _register_tool_callback
      parse_package_file "$repo_root/arch/Aurfile"    _register_tool_callback
      ;;
  esac
  parse_package_file "$repo_root/shared/Pipxfile" _register_tool_callback
}
